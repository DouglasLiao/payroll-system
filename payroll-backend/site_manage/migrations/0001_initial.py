    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_default', models.BooleanField(default=False, help_text='Se verdadeiro, este é o template inalterável usado como base para cálculos.', verbose_name='Template Padrão Sistema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Pode ser preenchido posteriormente pelo prestador no onboarding', max_length=255, null=True, verbose_name='Nome')),
                ('address', models.TextField(blank=True, help_text='Endereço preenchido pelo prestador no onboarding', null=True, verbose_name='Endereço Completo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_type', models.CharField(choices=[('CLOCK_IN', 'Entrada'), ('CLOCK_OUT', 'Saída')], default='CLOCK_IN', max_length=20, verbose_name='Tipo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_type', models.CharField(choices=[('CLOCK_IN', 'Entrada'), ('CLOCK_OUT', 'Saída')], max_length=20, verbose_name='Tipo de Registro')),
