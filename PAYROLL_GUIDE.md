...
GET    /api/providers/{id}/      # Detalhe
PUT    /api/providers/{id}/      # Atualizar
DELETE /api/providers/{id}/      # Excluir
```
...
GET    /api/payrolls/{id}/       # Detalhe com itens
PUT    /api/payrolls/{id}/       # Atualizar (apenas DRAFT)
POST   /api/payrolls/{id}/close/ # Fechar folha
POST   /api/payrolls/{id}/mark_paid/ # Marcar como pago
