...
from .models import Provider, Payment, PaymentStatus, Payroll, PayrollStatus as PayrollStatusEnum
...
class PayrollViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Payroll.objects.all().select_related('provider').prefetch_related('items')
