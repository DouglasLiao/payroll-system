    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, help_text='Empresa do usuário (null para Super Admin)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='api.company', verbose_name='Empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vt_value', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Valor fixo mensal do vale transporte', max_digits=10, verbose_name='Valor Vale Transporte')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(help_text='Empresa proprietária deste prestador', on_delete=django.db.models.deletion.CASCADE, related_name='providers', to='api.company', verbose_name='Empresa')),
                ('user', models.OneToOneField(blank=True, help_text='Usuário associado ao prestador (para login)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='provider_profile', to=settings.AUTH_USER_MODEL, verbose_name='Usuário')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='payroll',
            name='provider',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payrolls', to='api.provider', verbose_name='Prestador'),
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
